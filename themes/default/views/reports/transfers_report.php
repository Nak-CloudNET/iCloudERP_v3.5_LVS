        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown"><a href="#" id="pdf" data-action="export_pdf" class="tip" title="<?= lang('download_pdf') ?>"><i
							...
							<input type= "hidden" id = "reference_no" name ="reference_no" value="<?php echo $_GET['reference_no'] ?>">
							<input type= "hidden" id = "from_warehouse" name ="from_warehouse" value="<?php echo $_GET['from_warehouse'] ?>">
							<input type= "hidden" id = "to_warehouse" name ="to_warehouse" value="<?php echo $_GET['to_warehouse']?>">
							<input type= "hidden" id = "start_date" name ="start_date" value="<?php echo (isset($_GET['start_date']) ? $_GET['start_date'] : $this->erp->hrsd($start_date)) ?>">
							<input type= "hidden" id = "end_date" name ="end_date" value="<?php echo (isset($_GET['end_date']) ? $_GET['end_date'] : $this->erp->hrsd($end_date)) ?>">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <div class="row">
						<input type= "hidden" id = "ob_set" name ="ob_set" value="<?php echo $this->uri->segment(3) ?>">
                        <div class="col-sm-3">
				...
				<div class=" text-right">
					<div class="dataTables_paginate paging_bootstrap">
						<?= $pagination; ?>
						<?php //$this->erp->print_arrays($pagination); ?>
					</div>
				</div>
