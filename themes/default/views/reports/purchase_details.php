...
<?php
    echo form_open('reports/purchase_detail_actions', 'id="action-form"');
?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i><?= lang('purchase_detail'); ?><?php
            if ($this->input->post('start_date')) {
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
					...
					<?php echo form_open('reports/purchase_details', 'id="action-form" method="GET"'); ?>
                    <div class="row">
                        <div class="col-sm-3">
                    ...
                    <table class="table table-bordered table-hover table-striped table-condensed reports-table">
						...
						<?php 
							...
							if(count($purchases) > 0){
								...
								$table_purchase_order_items = "erp_purchase_items";
								$sql="SELECT 
										product_name,
										product_code,
										net_unit_cost,
										quantity,
										erp_purchase_items.tax,
										...
										shipping,
										supplier
										FROM erp_purchase_items LEFT JOIN erp_purchases
										ON erp_purchase_items.purchase_id=erp_purchases.id
										LEFT JOIN erp_companies ON erp_purchases.biller_id=erp_companies.id
										LEFT JOIN erp_warehouses ON erp_purchases.warehouse_id=erp_warehouses.id
