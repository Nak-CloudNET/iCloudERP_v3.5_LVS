<?php
	//$this->erp->print_arrays($this->session->userdata['biller_id']);
?>
						...
						<?php if ($Owner || $Admin || !$this->session->userdata('biller_id')) { ?>
							<div class="col-md-4">          
								<div class="form-group">
									...
									echo form_dropdown('biller_id', $billers, (isset($_POST['biller']) ? $_POST['biller'] : $Settings->default_biller), 'class="form-control" id="biller_id" placeholder="' . lang("select") . ' ' . lang("biller") . '" style="width:100%" required="required"')
									?>
								</div>
							</div>
						<?php }else{ ?>
							<div class="col-md-4" style="pointer-events: none;">          
								<div class="form-group">
									...
									echo form_dropdown('biller_id', $billers, (isset($_POST['biller']) ? $_POST['biller'] : $this->session->userdata('biller_id')), 'class="form-control" id="biller_id" placeholder="' . lang("select") . ' ' . lang("biller") . '" style="width:100%" required="required"')
									?>
								</div>
							</div>
						<?php } ?>
