...
<title><?php echo $this->lang->line("received_item_chea_kheng") . " " . $inv->reference_no; ?></title>
<style type="text/css">
	tbody{
		...
		<table class="table table-bordered table-hover" border="1">
			<thead>
				<tr>
					...
					<th style="width:10% !important;font-size:17px !important;"class="text-center"><?=lang('តម្លៃ ')?></th>
					<th style="width:10% !important;font-size:17px !important;" class="text-center"><?=lang('បញ្ចុះតម្លៃ ')?></th>
					<th style="width:12% !important;font-size:17px !important;"class="text-center"><?=lang('សរុប ')?></th>
				</tr>
			</thead>
			<tbody>
				<?php //for($i=0; $i<20; $i++){
				...
				<tr>
					...
					<?php
                            if ($Settings->product_discount) {
                                ...
                                echo '<td style="width: 100px; text-align:left; vertical-align:middle;">$' .($dpos == true ? $this->erp->formatMoney($row->item_discount)  : '').' '.'<small>('.$discount.')</small>' . '</td>';
                            }
                    ?>
					<td style="text-align:left; vertical-align:middle;">
				...
				<tr>
					...
					<td colspan="2" style="text-align:left; vertical-align:middle;"><?='បញ្ចុះតម្លៃ​ :'?></td>
					<td style="text-align:left; vertical-align:middle;">
						<div class="col-xs-3 text-left">$</div>
						<div class="col-xs-7 text-left">
				...
				<tr>
					<!-- <td colspan="6" style="text-align:center; vertical-align:middle;"></td> -->
					<td colspan="2"style="text-align:left; vertical-align:middle;"><?='ដឹកជញ្ជូន :'?></td>
					<td style="text-align:left; vertical-align:middle;">
						<div class="col-xs-3 text-left">$</div>
						<div class="col-xs-7 text-left">
				...
				<tr>
					<!-- <td colspan="6" style="text-align:center; vertical-align:middle;"></td> -->
					<td colspan="2"style="text-align:left; vertical-align:middle;"><?='ពន្ធកម្ម៉ុង :'?></td>
					<td style="text-align:left; vertical-align:middle;">
						<div class="col-xs-3 text-left">$</div>
						<div class="col-xs-7 text-left">
				...
				<tr>
					<!-- <td colspan="6" style="text-align:center; vertical-align:middle;"></td> -->
					<td colspan="2"style="text-align:left; vertical-align:middle;"><?='ប្រាក់សរុប :'?></td>
					<td style="text-align:left; vertical-align:middle;">
						<div class="col-xs-3 text-left">$</div>
						<div class="col-xs-7 text-left">
				...
				<tr>
					<!-- <td colspan="6" style="text-align:center; vertical-align:middle;"></td> -->
					<td colspan="2"style="text-align:left; vertical-align:middle;"><?='បង់ប្រាក់ :'?></td>
					<td style="text-align:left; vertical-align:middle;">
						<div class="col-xs-3 text-left">$</div>
						<div class="col-xs-7 text-left">
				...
				<tr>
					...
					<td colspan="2"style="text-align:left; vertical-align:middle;"><?='នៅខ្វះ :'?></td>
					<td style="text-align:left; vertical-align:middle;">
						<div class="col-xs-3 text-left">$</div>
						<div class="col-xs-7 text-left">
