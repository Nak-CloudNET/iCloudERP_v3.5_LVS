...
date,warehouses.`name`')
	...
	public function getPurchaseRequestId($id){
		$this->db->select('purchases_request.id, purchases_request.note,date, reference_no,companies.company as project, purchases_request.supplier, purchases_request.status, grand_total,order_status ');
