	...
	public function edit_convert($id = null)
    {
        ...
        if ($this->form_validation->run() == true) {
			...
			//========================== AVG Cost ===========================//
				...
				$each_cost 		= $this->site->editcalculateCONAVCost($iterm_to_id[$r], $total_raw_cost, $total_fin_qty, $qty_items);
				$total_finish_cost += $each_cost['cost'] / $iterm_to_qty[$r];
            ...
            $data               = array(
									...
									'total_finish_cost'=> $total_finish_cost
								);	
